    ...
    await queryInterface.bulkInsert("Reservations", [
      {
        ...
        status: "Reading",
        createdAt: new Date("2022-10-06 13:52:18")
      },
      {
        userId: 2,
        bookId: 6,
        ...
        status: "Pending",
        createdAt: new Date("2022-11-26 15:52:18")
      },
      {
        userId: 2,
        bookId: 9,
        ...
        status: "Finished",
        createdAt: new Date("2022-08-16 13:52:18")
      },
      {
        userId: 3,
        bookId: 2,
      ...
      },
      {
        ...
        status: "Finished",
        createdAt: new Date("2022-05-16 13:52:18")
      },
    ]);
  },
